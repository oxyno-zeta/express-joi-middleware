...
describe('Validation Tests', () => {
    ...
    beforeEach(() => {
        ...
        expressApp.get('/params/:id', library(paramsSchema), (req, res) => res.send('Ok'));
        const querySchema = {
            query: {
                limit: Joi.number().greater(5).required(),
            },
        };
        expressApp.get('/query', library(querySchema), (req, res) => res.send('Ok'));
        const bodySchema = {
            body: {
                id: Joi.string().min(5).required(),
            },
        };
        expressApp.post('/body', library(bodySchema), (req, res) => res.send('Ok'));
